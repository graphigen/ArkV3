...
INSERT INTO menu_items (
    ...
    target, css_class, icon
) VALUES 
-- Ana Menü Öğeleri
(1, 'header', 'Anasayfa', '/', 1, NULL, 1, '_self', '', 'home'),
(2, 'header', 'Ürün ve Çözümler', '#', NULL, NULL, 2, '_self', '', 'package'),
(3, 'header', 'Projelerimiz', '#', NULL, NULL, 3, '_self', '', 'briefcase'),
(4, 'header', 'Blog', '/blog', 14, NULL, 4, '_self', '', 'book-open'),
(5, 'header', 'Hakkımızda', '/hakkimizda', 2, NULL, 5, '_self', '', 'users'),
(6, 'header', 'İletişim', '/iletisim', 3, NULL, 6, '_self', '', 'phone'),

-- Ürün ve Çözümler Alt Menüleri
(7, 'header', 'Tiger Torch Temizleme Üniteleri', '/urunler/tiger-torc', 4, 2, 1, '_self', '', ''),
(8, 'header', 'Plazma Kesim Sarf Malzemeleri', '/urunler/plazma-sarf', 5, 2, 2, '_self', '', ''),
(9, 'header', 'ABB Robot Servis ve Bakım', '/urunler/abb-servis', 6, 2, 3, '_self', '', ''),
(10, 'header', 'Fronius Kaynak Makina Servis', '/urunler/fronius-servis', 7, 2, 4, '_self', '', ''),

-- Projelerimiz Alt Menüleri
(11, 'header', 'Robotik Kaynak Hücreleri', '/projeler/robotik-kaynak', 11, 3, 1, '_self', '', ''),
(12, 'header', 'Fikstur Sistemleri', '/projeler/fikstur', 13, 3, 2, '_self', '', ''),
(13, 'header', 'Pozisyoner Sistemleri', '/projeler/pozisyoner', 8, 3, 3, '_self', '', ''),
(14, 'header', 'Robotik Slider Sistemleri', '/projeler/slider', 9, 3, 4, '_self', '', ''),
(15, 'header', 'Mekanize Çözümler', '/projeler/mekanize', 10, 3, 5, '_self', '', ''),
(16, 'header', 'Lazer Kesim Tezgahları', '/projeler/lazer-kesim', 12, 3, 6, '_self', '', '')
...
-- Blog Categories (Sadece mevcut sütunlar)
INSERT INTO blog_categories (id, name, slug, description, color) VALUES 
(1, 'Otomasyon', 'otomasyon', 'Endüstriyel otomasyon haberleri', '#3B82F6'),
(2, 'Robotik', 'robotik', 'Robotik teknolojiler', '#10B981'),
(3, 'Kaynak Teknolojileri', 'kaynak-teknolojileri', 'Kaynak teknolojileri ve yenilikler', '#F59E0B'),
(4, 'Lazer Kesim', 'lazer-kesim', 'Lazer kesim teknolojileri', '#EF4444'),
(5, 'Sektör Haberleri', 'sektor-haberleri', 'Endüstri sektör haberleri', '#8B5CF6')
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name;

-- Blog Posts (Sadece mevcut sütunlar)
INSERT INTO blog_posts (
    id, title, slug, content, excerpt, status, category_id, 
...
(1, 'Endüstriyel Otomasyonun Geleceği', 'endustriyel-otomasyonun-gelecegi',
 ...
 'published', 1, '/blog/otomasyon-gelecek.jpg', 
...
(2, 'Robotik Kaynak Sistemlerinde Yenilikler', 'robotik-kaynak-sistemlerinde-yenilikler',
 ...
 'published', 2, '/blog/robotik-kaynak.jpg',
...
(3, 'Lazer Kesim Teknolojisinin Avantajları', 'lazer-kesim-teknolojisinin-avantajlari',
 ...
 'published', 4, '/blog/lazer-kesim.jpg',
